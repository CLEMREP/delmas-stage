        ...
        <aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
            <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul class="mt-6">
                    ...
                    <ul>
                        <li class="relative px-6 py-3">
                            @if(Str::startsWith(Route::currentRouteName(), 'procedures.'))
                                <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                            @endif
                    ...
                    <ul>
                        <li class="relative px-6 py-3">
                            @if(Str::startsWith(Route::currentRouteName(), 'contacts.'))
                                <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                            @endif
                            <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                               href="">
                                ...
                                <span class="ml-4">Mes Contatcs</span>
                            </a>
                        </li>
                    </ul>
                ...
                <div class="container flex items-center justify-end h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
                    ...
                    <ul class="flex items-center flex-shrink-0 space-x-6">
                        <div class="md:flex flex-col hidden">
                            ...
                            <span class="text-gray-200 text-right text-sm font-medium"></span>
                        </div>
                        <!-- Profile menu -->
                        <li class="relative">
                            <button
