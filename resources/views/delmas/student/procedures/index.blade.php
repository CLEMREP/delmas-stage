...
@section('content')
    <div class="flex flex-col sm:flex-row sm:items-center w-full">
        ...
        <div class="flex flex-col sm:flex-row w-full justify-end sm:w-2/3">
            ...
            <a href="{{ route('student.procedures.create') }}">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-end text-sm">
                                    <a href="{{ route('student.procedures.show', $procedure) }}">
                                    ...
                                    <form action="{{ route('student.procedures.destroy', $procedure) }}" method="POST">
                                        @csrf
