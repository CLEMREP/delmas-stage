...
@section('content')
    ...
    @if(Session::has('success'))
        <div class="p-4 mt-6 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800" role="alert" x-data="{ showMessage: true }" x-show="showMessage" x-init="setTimeout(() => showMessage = false, 5000)">
    ...
    <livewire:student.companies-table />
@endsection
