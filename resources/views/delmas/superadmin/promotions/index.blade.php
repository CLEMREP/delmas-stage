...
@section('content')
    <div class="flex flex-col sm:flex-row sm:justify-between mb-4 sm:items-center">
        ...
        <div class="flex flex-col sm:flex-row w-full justify-end sm:w-2/3">
            <a href="{{ route('superadmin.promotions.create') }}">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-end text-sm">
                                    <a href="{{ route('superadmin.promotions.edit', $promotion) }}">
                                    ...
                                    <form action="{{ route('superadmin.promotions.destroy', $promotion) }}" method="POST">
                                        @csrf
