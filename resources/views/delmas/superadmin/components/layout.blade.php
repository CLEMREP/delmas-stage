            ...
            <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul class="mt-6">
                    <li class="relative px-6 py-3">
                        @if(request()->routeIs('superadmin.index'))
                            <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                        @endif
                        <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="{{ route('superadmin.index') }}">
                ...
                <ul>
                    <li class="relative px-6 py-3">
                        @if(Str::startsWith(Route::currentRouteName(), 'superadmin.admin.'))
                            <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                        @endif
                        <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                           href="{{ route('superadmin.admin.index') }}">
                            ...
                            <span class="ml-4">Gestion des admins</span>
                        </a>
                    </li>
                </ul>
                ...
                <ul>
                    <li class="relative px-6 py-3">
                        @if(Str::startsWith(Route::currentRouteName(), 'superadmin.teacher.'))
                            <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                        @endif
                        <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                           href="{{ route('superadmin.teacher.index') }}">
                ...
                <ul>
                    <li class="relative px-6 py-3">
                        @if(Str::startsWith(Route::currentRouteName(), 'superadmin.series.'))
                            <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                        @endif
                        <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                           href="{{ route('superadmin.series.index') }}">
                            ...
                            <span class="ml-4">Gestion des séries</span>
                        </a>
                    </li>
                </ul>
                ...
                <ul>
                    <li class="relative px-6 py-3">
                        @if(Str::startsWith(Route::currentRouteName(), 'superadmin.promotions.'))
                            <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                        @endif
                        <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                           href="{{ route('superadmin.promotions.index') }}">
                ...
                <ul>
                    <li class="relative px-6 py-3">
                        @if(Str::startsWith(Route::currentRouteName(), 'superadmin.account.'))
                            <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                        @endif
                        <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                ...
                <div class="container flex items-center justify-end h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
                    ...
                    <ul class="flex items-center flex-shrink-0 space-x-6">
                        <div class="md:flex flex-col hidden">
                            ...
                            <span class="text-gray-200 text-right text-sm font-medium">Super Admin</span>
                        </div>
                        <!-- Profile menu -->
                        <li class="relative">
                            <button
