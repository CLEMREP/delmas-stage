...
@section('content')
    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
        Édition de l'admin {{ $admin->fullname() }}
    </h2>
    ...
    <form action="{{ route('superadmin.admin.update', $admin) }}" method="POST">
        ...
        <div class="flex flex-col sm:flex-row justify-between w-full">
            <label class="block text-sm w-full mb-4 sm:mb-0 sm:w-1/2 sm:mr-3">
                ...
                <input class="@error('lastname') border-red-500 @enderror block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="lastname" value="{{ $admin->lastname }}" placeholder="REPEL">
                @error('lastname')
            ...
            <label class="block text-sm w-full sm:w-1/2">
                ...
                <input class="@error('firstname') border-red-500 @enderror block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="firstname" value="{{ $admin->firstname }}" placeholder="Clément">
                @error('firstname')
                <div class="mt-2 flex flex-row items-center justify-start font-medium text-red-500 mb-2">
                    <svg class="w-5 h-5 inline mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                    <div>
        ...
        <div class="mt-4">
            <label class="block text-sm">
                ...
                <input class="@error('email') border-red-500 @enderror block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="email" value="{{ $admin->email }}" placeholder="contact@clement-repel.fr">
                @error('email')
                <div class="mt-2 flex flex-row items-center justify-start font-medium text-red-500 mb-2">
                    <svg class="w-5 h-5 inline mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                    <div>
        ...
        <div class="flex flex-col sm:flex-row justify-between mt-4 w-full">
            <label class="block text-sm w-full mb-4 sm:mb-0 sm:w-1/2 sm:mr-3">
                ...
                <div x-data="dropdown()" x-init="loadOptions()" class="flex flex-col">
                    <input name="serie_id" type="hidden" x-bind:value="selectedValues()">
                                ...
                                <div class="form-input items-center h-10 flex w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:outline-none dark:text-gray-300 dark:focus:shadow-outline-gray">
                                    <div class="flex flex-auto flex-wrap">
                                        ...
                                        <div x-show="selected.length == 0" class="flex-1">
                                            <input placeholder="Choisir une série(s)" class="w-full focus:outline-none border-transparent focus:border-transparent focus:ring-0 outline-none text-sm dark:bg-gray-700 dark:text-gray-300 dark:focus:shadow-outline-gray" x-bind:value="selectedValues()">
                                        </div>
                                    </div>
  ...
  " />
            ...
            <select x-cloak id="select" class="hidden">
                @foreach($series as $serie)
                    <option value="{{ $serie->getKey() }}">{{ $serie->name }}</option>
                @endforeach
            </select>

            <label class="block text-sm w-full sm:w-1/2">
                <span class="text-gray-700 dark:text-gray-400">Téléphone</span>
                <input class="@error('phone') border-red-500 @enderror block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="phone" value="{{ $admin->phone }}" placeholder="07 61 38 20 21">
                @error('phone')
                <div class="mt-2 flex flex-row items-center justify-start font-medium text-red-500 mb-2">
                    <svg class="w-5 h-5 inline mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                    <div>
